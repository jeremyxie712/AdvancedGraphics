...
def tone_map(F, stops = 1, gamma = 1.8):
...
def PFMplot(F_, stops = 1, gamma=1.8, save_img = True, filename = 'Default'):
	F = F_.copy()
...
if '__main__' == __name__:
	...
	scale_sin = np.linspace(0, np.pi, 512).reshape(-1, 1)
	...
	log_2_partitions = list(range(1,8))
